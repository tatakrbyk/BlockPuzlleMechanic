...
public class Grid : MonoBehaviour
{
    ...
    private void OnUpdateSquareColor(Config.SquareColor color) { currentActiveSquareColor_ = color; }
    ...
    private void SpawnGridSquares()
    {
        ...
        for (var row = 0; row < rows; row++)
        {
            for (var column = 0; column < columns; ++column)
            {
                ...
                _gridSquares[_gridSquares.Count - 1].transform.GetComponent<GridSquare>().SetImage(_lineIndicator.GetGridSquareIndex(square_index) % 2 == 0);
                square_index++;
            }
        }
    }
    ...
    private void CheckIfShapeCanBePlaced()
    {
        ...
        foreach (var square in _gridSquares)
        {
            ...
            {
                squareIndexes.Add(gridSquare.SquareIndex); // Selected Squares index add list
        ...
        if (currentSelectedShape.TotalSquareNumber == squareIndexes.Count) // shape placed  
        {
    ...
    private int ShouldPlayColorBonusAnimation()
    {
        ...
        {
            Debug.Log("Cannot find color for bous");
            return 0;
        }
    ...
    private int CheckIfSquaresAreCompleted(List<int[]> data) // check completed line
    {
